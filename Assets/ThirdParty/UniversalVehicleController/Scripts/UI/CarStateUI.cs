...
#pragma warning disable 0649
        ...
        [Header("UiPartsEnabled")]
        [SerializeField] private bool gear = true;
        [SerializeField] private bool tachometr = true;
        [SerializeField] private bool colors = true;
        [SerializeField] private bool turbo = true;
        [SerializeField] private bool updateDashboard = true;
        [SerializeField] private bool boost = true;
...
#pragma warning restore 0649
        ...
        public override bool Initialize(VehicleController vehicle)
        {
            ...
            Debug.Log("TurboGO is:" + turbo);
            Debug.Log("BoostGo is:" + boost);

            //TurboStateGO.SetActive(turbo);
            //BoostStateGO.SetActive(Car != null && Car.Engine.EnableBoost);
            //BoostStateGO.SetActive(boost);
